    ...
    private void constroiEstados(String estado) {
        ...
        for (j = 0; j < alfabeto.length; j++) {
            ...
            for (i = 0; i <= (proximaLinhaAFD - 1); i++) {
                ...
                if (fxAtualAFD.getCellData(i).toString().equals(estado)
